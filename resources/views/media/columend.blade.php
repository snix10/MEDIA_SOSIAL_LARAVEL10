    ...
    <div class="right-column">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                ...
                <p class="card-text text-justify"> <span class="h6">It might be time to visit
                        Iceland.</span> Iceland is so chill, and everything looks cool here. Also, we
                    heard
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <h6 class="card-title ">Likes <a href="#" class="ml-1"><small>.View
                            All</small>
                    </a> </h6>
                <div class="row no-gutters d-none d-lg-flex">
                    <div class="col-6 p-1">
                        <img src="img/avatar-dhg.png" alt="img" width="50px" height="50px"
                            class="rounded-circle mb-4">
                        <img src="img/avatar-fat.jpg" alt="img" width="50px" height="50px"
            ...
            <div class="card-footer">
                ...
                <p class="lead" style="font-size:18px;">Dave really likes these nerds, no one knows
                    why
                    though.</p>
            </div>
        </div>
